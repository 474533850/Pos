...
{
    public class SyncHelperDALpage : BaseDAL
    {
        ...
        /// <returns></returns>
        private static string GetUrl(string sid, string mod, string xls, string usercode, object version, int page = 1, int pageSize = 200)
        {
            string urlFormat = string.Format("{0}?sid={1}&mod={2}&xls={3}&usercode={4}&version={5}&page={6}&pageSize={7} ", baseUrl_Pull, sid, mod, xls, usercode, version ?? "", page, pageSize);
            return urlFormat;
        }
        #endregion
        ...
        #region 同步删除本地的数据
        private static void SyncDel(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            ...
            string url = GetUrl(sid, "delids", xls, usercode, version, page, pageSize);
        ...
        #region 同步分部
        private static void SyncDepartment(string sid, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            ...
            string url = GetUrl(sid, "ls", "", usercode, version, page, pageSize);
        ...
        #region 同步用户
        public static void SyncUser(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendLine("select max(xversion) from user");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "user", xls, usercode, version, page, pageSize);
        ...
        #region 同步仓库
        public static void SyncCnku(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendLine("select max(xversion) from cnku");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "cnku", xls, usercode, version, page, pageSize);
        ...
        #region 当前进销存帐
        private static void Syncku2(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from ku2");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "ku2", xls, usercode, version, page, pageSize);
        ...
        #region 货品大类
        public static void SyncGoodtype1(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendLine("select max(xversion) from goodtype1");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "goodtype1", xls, usercode, version, page, pageSize);
        ...
        #region 货品中类
        public static void SyncGoodtype2(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendLine("select max(xversion) from goodtype2");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "goodtype2", xls, usercode, version, page, pageSize);
        ...
        #region 货品小类
        public static void SyncGoodtype3(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendLine("select max(xversion) from goodtype3");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "goodtype3", xls, usercode, version, page, pageSize);
        ...
        #region 货品类型
        public static void SyncGoodkeys(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendLine("select max(xversion) from goodkeys");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "goodkeys", xls, usercode, version, page, pageSize);
        ...
        #region 货品信息
        private static void SyncGood(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from good");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "good", xls, usercode, version, page, pageSize);
        ...
        #region 货品价格
        private static void SyncGoodpric(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from goodpric");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "goodpric", xls, usercode, version, page, pageSize);
        ...
        #region 等级价格
        private static void SyncGoodpric2(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from goodpric2");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "goodpric2", xls, usercode, version, page, pageSize);
        ...
        #region 一品多码
        private static void SyncGbarcode(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from gbarcode");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "gbarcode", xls, usercode, version, page, pageSize);
        ...
        #region 货品规格
        private static void SyncGoodkind(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from goodkind");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "goodkind", xls, usercode, version, page, pageSize);
        ...
        #region 顾客类别
        private static void SyncClnttype(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from clnttype");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "clnttype", xls, usercode, version, page, pageSize);
        ...
        #region 顾客等级
        private static void SyncClntclss(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from clntclss");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "clntclss", xls, usercode, version, page, pageSize);
        ...
        private static void SyncClnt(string sid, string xls, string usercode, int page = 1, int pageSize = 200, object version = null)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendLine("select max(xversion) from clnt where SID is not null");
            if (version == null)
            {
                version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            }
            string url = GetUrl(sid, "clnt", xls, usercode, version, page, pageSize);
            ...
            {
                AsyncCallbackClnt(syncResult, sid, xls, usercode,page,pageSize,version);
            });
            wait_Sync.WaitOne();
        ...
        private static void AsyncCallbackClnt(SyncResultModel<ClntModel> syncResult, string sid, string xls, string usercode,int page,int pageSize, object version)
        {
            ...
            for (int i = 2; i <= syncResult.totalPage; i++)
            {
                SyncClnt(sid, xls, usercode, i, pageSize, version);
        ...
        #region 积分结余
        private static void SyncJjie2(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from jjie2");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "jjie2", xls, usercode, version, page, pageSize);
        ...
        #region 预存款结余
        private static void SyncOjie2(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from ojie2");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "ojie2", xls, usercode, version, page, pageSize);
        ...
        #region 促销活动
        private static void SyncSale(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from sale");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "sale", xls, usercode, version, page, pageSize);
        ...
        #region 促销活动货品
        private static void SyncSalegood(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from salegood");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "salegood", xls, usercode, version, page, pageSize);
        ...
        #region 促销赠品
        private static void SyncSalegoodX(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from salegoodX");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "salegoodX", xls, usercode, version, page, pageSize);
        ...
        #region 活动规则
        private static void SyncSalerule(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from salerule");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "salerule", xls, usercode, version, page, pageSize);
        ...
        #region 班次
        private static void SyncPosbantype(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from posbantype");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "posbantype", xls, usercode, version, page, pageSize);
        ...
        #region POS设置
        private static void SyncPossetting(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from possetting where issys=1");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "possetting", xls, usercode, version, page, pageSize);
        ...
        #region 线下优惠券
        private static void SyncTickoff(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from tickoff");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "tickoff", xls, usercode, version, page, pageSize);
        ...
        #region 线下优惠券明细
        private static void SyncTickoffmx(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from tickoffmx");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "tickoffmx", xls, usercode, version, page, pageSize);
        ...
        #region  账户
        private static void SyncPayt(string sid, string xls, string usercode, int page = 1, int pageSize = 200)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.AppendFormat("select max(xversion) from payt");
            object version = SQLiteHelper.ExecuteScalar(SQLiteHelper.connectionString, CommandType.Text, cmdText.ToString());
            string url = GetUrl(sid, "payt", xls, usercode, version, page, pageSize);
