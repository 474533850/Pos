...
namespace POS.WxPayAPI
{
    ...
    {
        static ApplicationLogger logger = new ApplicationLogger(typeof(WxPayApi).Name);
        /**
        * 提交被扫支付API
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            logger.Debug("WxPayApi:"+ "MicroPay request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            logger.Debug("WxPayApi:"+"MicroPay response : " + response);
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            logger.Debug("WxPayApi:"+ "Reverse request : " + xml);

            string response = HttpService.Post(xml, url, true, timeOut);

            logger.Debug("WxPayApi:"+ "Reverse response : " + response);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, int timeOut = 6)
        {
            ...
            logger.Debug("WxPayApi:"+ "Refund request : " + xml);
            string response = HttpService.Post(xml, url, true, timeOut);//调用HTTP通信接口提交数据到API
            logger.Debug("WxPayApi:"+ "Refund response : " + response);
	    ...
	    */
        public static WxPayData RefundQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            logger.Debug("WxPayApi:"+ "RefundQuery request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            logger.Debug("WxPayApi:"+ "RefundQuery response : " + response);
        ...
        */
        public static WxPayData DownloadBill(WxPayData inputObj, int timeOut = 6)
        {
            ...
            logger.Debug("WxPayApi:"+"DownloadBill request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            logger.Debug("WxPayApi:"+ "DownloadBill result : " + response);
	    ...
	    */
        public static WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
        {
            ...
            logger.Debug("WxPayApi:"+"ShortUrl request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            logger.Debug("WxPayApi:"+ "ShortUrl response : " + response);
