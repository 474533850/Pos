...
namespace POS.Helper
{
    ...
    /// 交接班打印
    /// </summary>
    public class PrintPosBanHelper
    {
        public static void Print(PosbanDetailModel posModel)
        {
            if (posModel != null)
            {
                ...
                try
                {
                    ...
                    report.EndInit();
                    //绑定
                    List<PosbanDetailModel> dataList = new List<PosbanDetailModel>();
